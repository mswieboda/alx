...
- the map boundary isn't as much of an issue anymore since the Enemy will move to the inner boundaries of the map when outside, via movement states. however they still can't move towards the center of the map, likely because their movement collision on empty tiles (surrounding all level maps) prevents them from moving?
