...
namespace Audio {
    ...
    static constexpr float DEFAULT_MUSIC_VOLUME = 0.70f;
    static constexpr float DEFAULT_SFX_VOLUME   = 3.00f;
    ...
    static constexpr float MAX_SFX_VOLUME       = 5.00f;
    static constexpr float MAX_MUSIC_VOLUME     = 2.50f;
