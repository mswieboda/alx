...
namespace FixtureRenderer {
    ...
    void draw_background(const Network& network, int min_tx, int max_tx, int min_ty, int max_ty, const Player* player = nullptr);
    ...
    /// Renders powered highlights around active refiners and spires.
    void draw_powered_indicators(const Network& network, int min_tx, int max_tx, int min_ty, int max_ty, const Player* player = nullptr);
