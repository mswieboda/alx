...
void spawn_hit_sparks(ParticleSystem& ps, float x, float y, float kb_vx = 0.0f, float kb_vy = 0.0f, int count = 35, int z_index = 10, int y_sort_override = -2147483647 - 1);
